...
await step("tugas proyek: desain kartu ucapan", "POST", `${T}/projects/${proj.id}/tasks`, { name: "Desain kartu ucapan korporat" });
const task2 = await step("tugas proyek: nego vendor kotak", "POST", `${T}/projects/${proj.id}/tasks`, { name: "Negosiasi vendor kotak premium" });

...
export const UI = {
  ...
  trialSisa: { id: "trial, sisa", en: "trial," },
  ...
  descPembayaranAman: {
    id: "Pembayaran aman via Midtrans (QRIS, transfer bank, kartu, e-wallet). Akun aktif otomatis setelah pembayaran terkonfirmasi. Tim & grup perusahaan dapat menghubungi kami untuk penawaran khusus.",
    en: "Secure payment via Midtrans (QRIS, bank transfer, card, e-wallet). Your account activates automatically once payment is confirmed. Teams & company groups can contact us for a custom quote.",
  },
